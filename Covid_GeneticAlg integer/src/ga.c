...
void generate_genome(Genome * genome) {
	...
	genome -> c2[0] = random_int(4096);
	genome -> c2[1] = random_int(512);
	genome -> c2[2] = random_int(64);
	genome -> c2[3] = random_int(64);
	genome -> c2[4] = random_int(512);
	genome -> c2[5] = random_int(512);
	genome -> c2[6] = random_int(512);
	genome -> c2[7] = random_int(64);
	genome -> c2[8] = random_int(512);
	genome -> c2[9] = random_int(4096);
	genome -> c2[10] = random_int(4096);
...
/*
 * Main function for the mutation operator with a scaling factor
 * that reduces the mutation in time
 *
 * @param genome genome of a single individual
 * @param prob probability of the mutation
...
void crossover_genomes(
	...
	//function crossing two individuals randomly
 ...
 * This method chooses the individuals according to their fitness, individuals with
 * lower fitness have a lower change of being selected.
 *
 * @param population the initial population with fitness values calculated
 * @param pop_size the total population size
